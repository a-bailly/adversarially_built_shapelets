...
//Map integer: filthy hack,could be done better. Range is 1-8
    ...
    public void initializeShapeletsKMeans() throws Exception {
        ...
        Random rand = new Random();
        for (int r=0; r<R; r++) {
            double[][] segments_r = new double[n_draw][L[r]];
    ...
    private void train(Instances data) throws Exception {
        ...
        System.out.println("LS -- #TS " + train.length);
...
//remove the class value
    ...
    public static void main(String[] args) throws Exception{
        ...
        String[] list_datasets = {"MoteStrain", "ShapeletSim", "DiatomSizeReduction", "ArrowHead"};
        if ( args.length > 0 ) {
            list_datasets = args;
        }

        /*"SonyAIBORobotSurface", "ItalyPowerDemand", "MoteStrain",
        ...
        for (String s: list_datasets) {
            ...
            System.out.println(dataset+", LS (ER) = " + (1 - accuracy));
        }
    }
}
